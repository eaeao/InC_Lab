...
urlpatterns = [
    ...
    url(r'^itembank/$', itembankview.itembank_question),
    ...
    url(r'^itembank/testpaper/submit/$', itembankview.itembank_testpaper_submit),
    url(r'^itembank/testpaper/analysis/$', itembankview.itembank_testpaper_analysis),
    url(r'^itembank/testpaper/analysis/result/$', itembankview.itembank_testpaper_analysis_result),
    url(r'^itembank/testpaper/add/$', itembankview.itembank_testpaper_add),
