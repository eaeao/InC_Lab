...
var initHooks = []
CodeMirror$1.defineInitHook = function(f) {initHooks.push(f)}
...
var addEditorMethods = function(CodeMirror) {
  ...
  CodeMirror.prototype = {
    ...
    moveH: methodOp(function(dir, unit) {
      var cm = this
      cm.extendSelectionsBy(function(range$$1) {
        if (cm.display.shift || cm.doc.extend || range$$1.empty())
          { return findPosH(cm.doc, range$$1.head, dir, unit, cm.options.rtlMoveVisually) }
        else
    ...
    moveV: methodOp(function(dir, unit) {
      ...
      doc.extendSelectionsBy(function(range$$1) {
        if (collapse)
          { return dir < 0 ? range$$1.from() : range$$1.to() }
        var headPos = cursorCoords(cm, range$$1.head, "div")
    ...
    setSize: methodOp(function(width, height) {
      ...
      var lineNo$$1 = cm.display.viewFrom
      cm.doc.iter(lineNo$$1, cm.display.viewTo, function(line) {
        if (line.widgets) { for (var i = 0; i < line.widgets.length; i++)
          { if (line.widgets[i].noHScroll) { regLineChange(cm, lineNo$$1, "widget"); break } } }
        ++lineNo$$1
      })
      cm.curOp.forceUpdate = true
